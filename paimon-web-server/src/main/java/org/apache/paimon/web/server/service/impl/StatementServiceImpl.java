...
public class StatementServiceImpl extends ServiceImpl<StatementMapper, StatementInfo>
    ...
    @Override
    public List<StatementInfo> listStatementsByPage(int current, int size) {
        QueryWrapper<StatementInfo> queryWrapper = new QueryWrapper<>();
        queryWrapper.orderByDesc("create_time");
        Page<StatementInfo> page = new Page<>(current, size);
        IPage<StatementInfo> selectHistoryPage = statementMapper.selectPage(page, queryWrapper);
