...
public abstract class ExecutorContext {
    ...
    protected ExecutorContext(Configuration configuration, RuntimeExecutionMode executionMode) {
    ...
    private EnvironmentSettings createEnvironmentSettings(RuntimeExecutionMode mode) {
